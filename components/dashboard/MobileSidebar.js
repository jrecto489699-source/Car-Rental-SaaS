...
import {
  ...
  BarChart3, Settings, Zap, X, LogOut, CalendarDays
} from 'lucide-react'
      ...
      {isOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed left-0 top-0 bottom-0 w-[260px] bg-slate-950 border-r border-white/[0.07] z-50 lg:hidden flex flex-col"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 h-16 border-b border-white/[0.07]">
                      ...
                      return (
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive
                              ? 'bg-gradient-to-r from-blue-600/20 to-blue-500/5 text-blue-400 border border-blue-500/25'
                        ...
                        >
                          ...
                          <Icon size={17} className={cn('shrink-0', isActive ? 'text-blue-400' : 'text-slate-500')} />
                          {item.label}
                        </Link>
                      )
                    })}
            ...
            <div className="p-3 border-t border-white/[0.07]">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-500 hover:text-rose-400 hover:bg-rose-500/[0.08] transition-colors"
              >
                <LogOut size={17} className="text-slate-600" />
                Sign Out
              </button>
            </div>
          </motion.aside>
